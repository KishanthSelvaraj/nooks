...
export default async function ProductsPage() {
  try {
    ...
    return (
      <section className="bg-white md:pt-[100px] pt-[70px]">
        ...
        <div className="text-center">
           ...
           We provides top-quality, durable office furniture designed for comfort, functionality, and modern aesthetics, ensuring optimal learning environments.
           </p>

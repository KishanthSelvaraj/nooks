...
const Footer = () => {
  return (
    ...
    //   <div className="lg:flex w-full md:divide-y md:md:divide-y-0 ">
    //     {/* Column 1 */}
    //     <div className="lg:w-2/3 p-6 md:p-14 xl:pt-20 xl:pb-12 flex flex-col items-start">
    //       <h2 className="font-bold text-3xl xl:text-4xl leading-snug text-start">
    //         Modern Furniture Crafted <br />
    //         <span className="text-[#34b69c]">for Comfort.</span>
    //       </h2>
    //       <div className="mt-14 xl:mt-20">
    //         <nav className="flex gap-6 flex-wrap justify-center text-lg font-medium">
    //           <div className="py-2 hover:text-gray-400"><a href="#">Features</a></div>
    //           <div className="py-2 hover:text-gray-400"><a href="#">Products</a></div>
    //           <div className="py-2 hover:text-gray-400"><a href="#">Contact</a></div>
    //         </nav>
    //       </div>
    //     </div>
    ...
    //     {/* Column 3 */}
    //     <div className="lg:w-1/3 p-6 md:pl-14 xl:pt-20 xl:pb-12 flex flex-col items-start justify-around">
    ...
    //           <a href="#" className="hover:text-gray-400"><SlSocialInstagram className="w-6 h-6" /></a>
    //           <a href="#" className="hover:text-gray-400">
    //             <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    //               <path strokeLinecap="round" strokeLinejoin="round" d="M18 2.25H6A3.75 3.75 0 002.25 6v12A3.75 3.75 0 006 21.75h6v-6.75h-2.25V12H12V9.75A3.75 3.75 0 0115.75 6h2.25V9h-2.25a.75.75 0 00-.75.75v2.25H18l-.75 3h-2.25v6.75h4.5A3.75 3.75 0 0021.75 18V6A3.75 3.75 0 0018 2.25z" />
    //             </svg>
    //           </a>
    //           <a href="#" className="hover:text-gray-400">
    //             <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    //               <path strokeLinecap="round" strokeLinejoin="round" d="M10.478 9.084l4.836 2.923-4.836 2.923V9.084z" />
    //               <path strokeLinecap="round" strokeLinejoin="round" d="M22.5 12c0-1.959-.159-3.917-.477-5.844-.321-1.94-1.915-3.514-3.852-3.83A80.695 80.695 0 0012 2.5a80.695 80.695 0 00-6.171.326c-1.937.316-3.531 1.89-3.852 3.83A45.632 45.632 0 001.5 12c0 1.959.159 3.917.477 5.844.321 1.94 1.915 3.514 3.852 3.83A80.695 80.695 0 0012 21.5a80.695 80.695 0 006.171-.326c1.937-.316 3.531-1.89 3.852-3.83.318-1.927.477-3.885.477-5.844z" />
    //             </svg>
    //           </a>
    //         </div>
    //       </div>
    //     </div>
    //   </div>
    //   <p className="pb-2 text-xs">© 2023 XYZ, LLC</p>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div className="md:w-32  w-24 h-auto lg:mx-10 ">
        ...
        <ul class="flex flex-col sm:flex-row items-center gap-5 sm:gap-12">
          ...
          {/* <li><a href="jaascript:;"
              class="text-lg font-normal text-gray-800 transition-all duration-300 hover:text-[#069376] focus-within:text-[#069376] focus-within:outline-0">Blogs</a>
          </li>
          <li><a href="jaascript:;"
              class="text-lg font-normal text-gray-800 transition-all duration-300 hover:text-[#069376] focus-within:text-[#069376] focus-within:outline-0">Support</a>
          </li> */}
        </ul>
      </div>
      <div class="pt-7 flex flex-col min-[520px]:flex-row items-center justify-between gap-6">
        <span class="text-sm font-normal text-gray-500">©<a href="https://pagedone.io/">Nooks</a> 2024, All rights reserved.</span>
